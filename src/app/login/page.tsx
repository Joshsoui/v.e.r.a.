...
function LoginForm() {
  ...
  return (
    <>
      {resetSuccess && (
        <div className="mb-4">
          <Alert variant="success">Je wachtwoord is gewijzigd. Je kunt nu inloggen.</Alert>
        </div>
      )}
      {error && (
        <div className="mb-4">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" className="mb-1 text-xs text-vera-600 hover:underline">
              Wachtwoord vergeten?
            </Link>
          </div>
          <Input
